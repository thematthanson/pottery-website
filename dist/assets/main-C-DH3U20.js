(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function t(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(e){if(e.ep)return;e.ep=!0;const r=t(e);fetch(e.href,r)}})();window.onload=function(){emailjs.init(void 0),console.log("EmailJS initialized")};let l=[];document.addEventListener("DOMContentLoaded",async()=>{try{throw new Error("Google Sheets API Key or Spreadsheet ID is not defined.")}catch(n){console.error("Error initializing data:",n)}});async function y(n,s,t){try{const o=`https://sheets.googleapis.com/v4/spreadsheets/${s}/values/${t}?key=${n}`,e=await fetch(o);if(!e.ok)throw new Error(`HTTP error! Status: ${e.status}`);const r=await e.json();return console.log("Fetched data:",r),!r.values||!Array.isArray(r.values)?(console.error("Data is not in the expected format:",r),[]):r.values}catch(o){throw console.error("Error fetching data:",o),o}}function g(n){const s=document.getElementById("pottery-grid");if(!s){console.error("Pottery grid element not found");return}s.innerHTML="",n.forEach(([t,o,e,r,i,d,a,u,m,w],p)=>{if(!t||!o){console.warn("Skipping invalid pottery item:",{id:t,imageUrl:o});return}console.log(`Rendering item ${p+1}:`,{id:t,imageUrl:o,gifUrl:m});const c=(a==null?void 0:a.toLowerCase())==="taken",f=document.createElement("div");f.className=`card ${c?"taken":""}`,f.innerHTML=`
            ...
            <div class="p-4">
                ...
                <p class="text-gray-600 mb-4">Price: $${u||"N/A"}</p>
        ...
        `,s.appendChild(f)})}function h(n){console.log("Opening modal for pottery:",n);const s=document.getElementById("pottery-modal");if(!s){console.error("Modal element not found");return}const t=s.querySelector("form"),o=t.querySelector('input[name="pottery_id"]');if(!t||!o){console.error("Form or pottery ID input not found in modal");return}t.reset(),o.value=n;const e=l.find(u=>u[0]===n);if(!e){console.error("Pottery item not found for ID:",n);return}const[r,i,,,,,,,,d]=e,a=document.getElementById("modal-images");a&&(a.innerHTML=`
